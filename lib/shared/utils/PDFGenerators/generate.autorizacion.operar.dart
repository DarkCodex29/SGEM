              ...
              child: pw.Column(children: [
                ...
                pw.Container(
                    ...
                    decoration: const pw.BoxDecoration(
                      color: PdfColor(0.94, 0.94,
                          0.94), // Fondo gris claro (similar al de la imagen)
                      borderRadius: pw.BorderRadius.all(
                          pw.Radius.circular(8)), // Bordes redondeados
                    ),
