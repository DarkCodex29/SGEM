              ...
              children: [
                pw.Row(
                    ...
                    children: [
                      ...
                      pw.Container(
                          ...
                          child: pw.Text(
                              "AUTORIZACION PARA USO DE EQUIPOS MOVILES"))
                    ]).padding(const pw.EdgeInsets.only(bottom: 10)),
                cardCustom(pw.Column(
                  children: [
                ...
                cardCustom(pw.Column(children: [
                  pw.Container(
                    ...
                    alignment: pw.Alignment.centerLeft,
                    child: pw.Text(
                            "- El porcentaje minimo aprobatorio es de 50%. Siendo el primer modulo pre-registro para el siguiente  asi sucesivamente.")
